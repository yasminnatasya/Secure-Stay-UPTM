...
class _EditAddressScreenState extends State<EditAddressScreen> {
              ...
              Expanded(
                ...
                children: [
                  Column(children: [
                    ...
                    SizedBox(height: 5.v),
                    phoneNumberField(
                        editAddressController.phoneNumberController, (p0) {
  ...
  Widget _buildMasterUsernameAddresslineOne() {
    return CustomTextFormField(
      controller: editAddressController.masterUsernameAddresslineOneController,
  ...
  Widget _buildMasterUsernameAddresslineTwo() {
    return CustomTextFormField(
      controller: editAddressController.masterUsernameAddresslineTwoController,
      hintText: "Enter address",
      enableBorder: false,
    );
  }
